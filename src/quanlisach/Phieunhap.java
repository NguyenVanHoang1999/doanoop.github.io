...
public class Phieunhap {
    ...
    public void Xuat(){
     System.out.printf("|%-20s|%-20s|%-20s|%-20d|%-20f|%-20f|%-20s|%-20s|\n",this.maphieunhap,this.masach,this.ngaynhap,this.soluong,this.dongia,this.tongtien,this.manhacungcap,this.manhanvien); 
